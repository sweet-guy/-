...
/**
 * Created by Umbrella on 2019/2/19.
 */

public class MyNiceController extends NiceVideoPlayerController implements View.OnClickListener,
    ...
    private TextView nice_menu;
    private TextView clarity;

    public MyNiceController(Context context) {
        super(context);
        mContext=context;
        init();
    }
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.my_controller_layout, this, true);
        nice_menu = findViewById(R.id.nice_menu);
        ...
        nice_menu.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        {
            Toast.makeText(mContext,"点击目录",Toast.LENGTH_LONG).show();
        }else if (v == this) {
